...
create table if not exists public.homestead_products (
  ...
  status text not null default 'coming_soon' check (status in ('available', 'preorder', 'sold_out', 'coming_soon')),
...
(slug, name, category, description, price_cents, price_note, unit_label, available_quantity, status, availability_window, pickup_note, image_emoji, image_alt, sold_out_message, featured, sort_order)
values
('pasture-raised-meat-chickens', 'Pasture-Raised Meat Chickens', 'Meat chickens', 'Whole processed chickens raised on our family homestead. Reserve your birds ahead of processing day.', 0, 'Price will be confirmed before pickup.', 'whole chickens', 30, 'preorder', 'Next batch: update with processing month', 'Local pickup near Lexington, KY. We will confirm date, time, and final total before pickup.', '🐓', 'Pasture-raised meat chickens from Stiffler Homestead', 'This chicken batch is sold out. Contact us to get on the next availability list.', true, 10),
('pasture-raised-pork', 'Pasture-Raised Pork', 'Pork', 'Homestead-raised pork availability, deposits, shares, and cuts can be listed here as each season is ready.', 0, null, 'shares or cuts', 0, 'coming_soon', 'Future availability', 'Join the interest list and we will contact you when pork is available.', '🐖', 'Pasture-raised pork from Stiffler Homestead', 'Pork is not currently available. Contact us for the next season.', true, 20),
('pasture-raised-lamb', 'Pasture-Raised Lamb', 'Lamb', 'Whole/half lamb or cut availability can be edited here when lamb is ready for reservation.', 0, null, 'shares or cuts', 0, 'coming_soon', 'Future availability', 'Join the lamb interest list and we will reach out when availability opens.', '🐑', 'Pasture-raised lamb from Stiffler Homestead', 'Lamb is not currently available. Contact us for next availability.', true, 30),
('farm-fresh-eggs', 'Farm-Fresh Eggs', 'Eggs', 'Egg availability from our laying hens. Update quantity and price as weekly inventory changes.', 0, 'Egg price will be confirmed before pickup.', 'dozens', 0, 'sold_out', 'Weekly availability varies', 'Local pickup only. We will confirm current inventory before pickup.', '🥚', 'Farm-fresh eggs from Stiffler Homestead', 'Eggs are currently sold out. Contact us for the next available dozens.', true, 40),
('homestead-honey', 'Homestead Honey', 'Honey', 'A future spot for honey if/when it becomes available from the homestead.', 0, null, 'jars', 0, 'coming_soon', 'Possible future product', 'Join the interest list and we will let you know if honey becomes available.', '🍯', 'Future homestead honey from Stiffler Homestead', 'Honey is not available yet. Contact us to hear about future batches.', false, 50)
