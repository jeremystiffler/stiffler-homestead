...
('farm-fresh-eggs', 'Farm-Fresh Eggs', 'Eggs', 'Egg availability from our laying hens. Update quantity and price as weekly inventory changes.', 0, 'Egg price will be confirmed before pickup.', 'dozens', 0, false, 'available', 'Weekly availability varies', 'Local pickup only. We will confirm current inventory before pickup.', '🥚', 'Farm-fresh eggs from Stiffler Homestead', 'Eggs are currently sold out. Contact us for the next available dozens.', true, 40),
