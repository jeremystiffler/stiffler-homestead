...
export const SITE_CONFIG = {
  ...
  siteUrl: envValue(process.env.NEXT_PUBLIC_SITE_URL, "https://stifflerhomestead.store"),
  amazonTag: "stifflerhom01-20",
  contactEmail: envValue(process.env.NEXT_PUBLIC_CONTACT_EMAIL, "info@stifflerhomestead.store"),
  areaServed: ["Lexington", "Nicholasville", "Georgetown", "Versailles", "Winchester", "Richmond", "Central Kentucky"],
