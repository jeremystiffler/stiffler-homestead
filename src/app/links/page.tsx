...
export const metadata: Metadata = {
  title: "Links | Stiffler Homestead Gear, Resources & Affiliate Links",
  description:
    "Search Stiffler Homestead links by title, tag, or category: chicken coop gear, canning supplies, family tech, homestead tools, and affiliate resources.",
  alternates: { canonical: "/links" },
  openGraph: {
    title: "Links | Stiffler Homestead",
    description:
      "A searchable link hub for Stiffler Homestead gear, family tech, homestead tools, and affiliate resources.",
    url: "/links",
...
export default function LinksPage() {
  ...
  const jsonLd = [
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "ItemList",
      name: "Stiffler Homestead searchable links",
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:py-14">
      ...
      <section className="rounded-[2rem] bg-[#183b25] p-5 text-white shadow-xl shadow-green-900/10 sm:p-8 md:p-12">
        <p className="text-sm font-black uppercase tracking-[0.25em] text-amber-300">Stiffler Homestead links</p>
        <h1 className="mt-3 max-w-5xl text-3xl font-black leading-tight sm:text-5xl md:text-6xl">
          Links for the gear, tools, and resources we keep mentioning.
        </h1>
        <p className="mt-5 max-w-3xl text-lg leading-8 text-white/80">
          A searchable link page for Stiffler Homestead videos, blog posts, and recommended resources. Search by link title, filter by tags, or browse categories when you are trying to find the chicken door, canning gear, family tech, or “what was that thing Jeremy mentioned?” without spelunking through the internet like a raccoon with Wi‑Fi.
        </p>
